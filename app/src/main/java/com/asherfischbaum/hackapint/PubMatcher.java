...
public class PubMatcher extends AsyncTask<Void, Void, Void> {
    ...
    final String MPS_RESULTS = "results";
    final String MPS_ADDR = "formatted_address";
    final String MPS_GEOM = "geometry";
    final String MPS_LOC = "location";
    final String MPS_NAME = "name";
